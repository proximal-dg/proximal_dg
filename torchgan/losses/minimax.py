...
from .loss import DiscriminatorLoss, GeneratorLoss, ProximalDiscriminatorLoss,ProximalGeneratorLoss

__all__ = ["MinimaxGeneratorLoss", "MinimaxDiscriminatorLoss","ProximalMinimaxDiscriminatorLoss","ProximalMinimaxGeneratorLoss"]
...
class MinimaxGeneratorLoss(GeneratorLoss):
    ...
    def __init__(self, reduction="mean", nonsaturating=False, override_train_ops=None):
...
class ProximalMinimaxGeneratorLoss(ProximalGeneratorLoss):
    r"""Minimax game generator loss from the original GAN paper `"Generative Adversarial Networks
    by Goodfellow et. al." <https://arxiv.org/abs/1406.2661>`_
    ...
    def __init__(self, reduction="mean", nonsaturating=False, override_train_ops=None,eval_only=False,lamda_prox=0.10,steps=10,proximal_discriminator_loss=None):
        super(ProximalMinimaxGeneratorLoss, self).__init__(reduction, override_train_ops,eval_only,lamda_prox,steps,proximal_discriminator_loss)
        self.nonsaturating = nonsaturating
...
class ProximalMinimaxDiscriminatorLoss(ProximalDiscriminatorLoss):
    r"""Minimax game discriminator loss from the original GAN paper `"Generative Adversarial Networks
    by Goodfellow et. al." <https://arxiv.org/abs/1406.2661>`_
    ...
    def __init__(self, label_smoothing=0.0, reduction="mean", override_train_ops=None,lamda_prox=0.10,steps=10):
        super(ProximalMinimaxDiscriminatorLoss, self).__init__(reduction, override_train_ops,lamda_prox,steps)
        self.label_smoothing = label_smoothing
