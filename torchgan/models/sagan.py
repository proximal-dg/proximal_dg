...
__all__ = ["SAGANGenerator", "SAGANDiscriminator"]


class SAGANGenerator(Generator):
    r"""Self Attention GAN (SAGAN) generator from
    ...
    Args:
        ...
        step_channels (int, optional): Number of channels in multiples of which the SAGAN steps up
    ...
    def __init__(
        ...
        super(SAGANGenerator, self).__init__(encoding_dims, label_type)
...
class SAGANDiscriminator(Discriminator):
    r"""Self Attention GAN (SAGAN) discriminator from
    `"Unsupervised Representation Learning With Deep Convolutional Generative Aversarial Networks
    by Radford et. al. " <https://arxiv.org/abs/1511.06434>`_ paper
    ...
    def __init__(
        ...
        super(SAGANDiscriminator, self).__init__(in_channels, label_type)
