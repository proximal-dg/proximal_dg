...
class Visualize(object):
    ...
    def __init__(self, visualize_list, visdom_port=8097, log_dir=None, writer=None,verbose=True):
        self.logs = {}
...
class GradientVisualize(Visualize):
    ...
    def __init__(self, visualize_list, visdom_port=8097, log_dir=None,verbose=True, writer=None):
